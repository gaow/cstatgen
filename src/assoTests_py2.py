...
class Fisher2X2(BaseAction):
    ...
    def __init__(self, alternative, midp=False):
...
class VTFisher(BaseAction):
    ...
    def __init__(self, alpha, alternative=1, midp=False):
...
class WeightedGenotypeTester(BasePermutator):
    ...
    def __init__(self, alternative, info, actions):
