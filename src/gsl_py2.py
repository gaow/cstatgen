...
def gsl_ran_gamma_pdf(x, a, b):
    return _gsl.gsl_ran_gamma_pdf(x, a, b)
gsl_ran_gamma_pdf = _gsl.gsl_ran_gamma_pdf

def gsl_ran_tdist_pdf(x, nu):
    return _gsl.gsl_ran_tdist_pdf(x, nu)
